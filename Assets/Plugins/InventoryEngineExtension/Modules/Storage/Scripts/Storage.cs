    ...
    public class Storage : MonoBehaviour
    {
        ...
        protected virtual void PopulateStorageInventory()
        {
            ...
            if (useLoot)
            {
                ...
                {
                    int slot = 0;
                    int lootItems = Random.Range(1, randomLootMaxItems);
                ...
                MMInventoryEvent.Trigger(MMInventoryEventType.ContentChanged, null, _storageInventory.name, null, 0, 0, _playerID);
            }
        }
        ...
        public virtual void OpenStorage()
        {
            ...
            MMInventoryEvent.Trigger(MMInventoryEventType.Redraw, null, _storageInventory.name, null, 0, 0, _playerID);
