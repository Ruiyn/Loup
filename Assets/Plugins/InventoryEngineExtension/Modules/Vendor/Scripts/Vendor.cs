...
namespace MoreMountains.InventoryEngine
{
    public class Vendor : MonoBehaviour
    {
        ...
        protected virtual void PopulateVendorInventory()
        {
            ...
            MMInventoryEvent.Trigger(MMInventoryEventType.ContentChanged, null, vendorInventory.name, null, 0, 0, _playerID);
        }
        ...
        public virtual void PayForItem(int amount)
        {
            ...
            for (int i = 0; i < currencyItems.Count; i++)
            {
                ...
                if ((restToPay - quantity) == 0)
                {
                    ...
                    MMInventoryEvent.Trigger(MMInventoryEventType.ContentChanged, null, mainInventory.name, null, 0, 0, _playerID);
                    return;
                }
                //we can pay with 
        ...
        public virtual void OpenVendor()
        {
            ...
            MMInventoryEvent.Trigger(MMInventoryEventType.Redraw, null, vendorInventory.name, null, 0, 0, _playerID);
